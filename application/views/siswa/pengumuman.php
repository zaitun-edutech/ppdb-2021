  ...
  <div class="content">
        ...
        <div class="panel-body" style="color:red">
          <h3>
            <center>
              ...
              Sebagai Calon Peserta Didik Baru <b>SMK Mitra Sehat Mandiri Sidoarjo</b>.
            </center>
            <br>
          </h3>
        </div>
    ...
    <?php }else{ ?>
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <h3>
            <center>~ Belum ada Pengumuman dari Panitia PPDB Online <?php echo $user['nama_lengkap']; ?> ~</center>
          </h3>
        </div>
      </div>
    <?php } ?>
