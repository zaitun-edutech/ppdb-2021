<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <!--<div class="form-group" style="padding-bottom:30px;">
      ...
      <div class="col-sm-9 prepend-icon" style="margin-top:1px;">
        <input type="text" name="nik" class="form-control bg-blue class" onkeypress="return hanyaAngka(this);" maxlength="16" placeholder="NIK" data-parsley-group="block1" data-parsley-errors-container='div[id="error-nik"]' required>
        <i class="fa fa-users" style="margin-left:15px;"></i>
        <div id="error-nik" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      ...
      <div id="error-komp-ahli" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
    </div>
</div>
